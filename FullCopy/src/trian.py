...
class TriAN(nn.Module):
    ...
    def __init__(self, args):
        ...
        doc_input_size = 2 * self.embedding_dim
        ...
        qst_input_size = self.embedding_dim
    ...
    def forward(self, p, p_mask, q, q_mask, c, c_mask, d_chars, q_chars, c_chars):
        ...
        p_rnn_input = torch.cat([p_emb, p_q_weighted_emb], dim=2)
        c_rnn_input = torch.cat([c_emb, c_q_weighted_emb, c_p_weighted_emb], dim=2)
        q_rnn_input = torch.cat([q_emb], dim=2)
